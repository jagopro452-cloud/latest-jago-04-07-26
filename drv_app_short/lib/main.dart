...
void main() async {
  ...
  try {
    ...
    if (isJailbroken) {
      debugPrint('[SECURITY] Rooted/jailbroken driver device detected');
      FirebaseCrashlytics.instance.log('Rooted/jailbroken driver device detected');
    }
  } catch (_) {}
  try {
  ...
  static ThemeData _darkTheme() {
    ...
    return ThemeData(
      ...
      textTheme: GoogleFonts.poppinsTextTheme(ThemeData.dark().textTheme)
          .copyWith(
            headlineLarge: GoogleFonts.poppins(fontSize: 32, fontWeight: FontWeight.w500, letterSpacing: -0.3, color: const Color(0xFFE6EDF3)),
            headlineMedium: GoogleFonts.poppins(fontSize: 28, fontWeight: FontWeight.w500, letterSpacing: -0.2, color: const Color(0xFFE6EDF3)),
            titleLarge: GoogleFonts.poppins(fontSize: 20, fontWeight: FontWeight.w500, color: const Color(0xFFE6EDF3)),
            titleMedium: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w500, color: const Color(0xFFE6EDF3)),
            bodyLarge: GoogleFonts.poppins(fontSize: 15, fontWeight: FontWeight.w400, height: 1.4, color: const Color(0xFFB0BEC5)),
            bodyMedium: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.w400, height: 1.4, color: const Color(0xFFB0BEC5)),
            bodySmall: GoogleFonts.poppins(fontSize: 12, fontWeight: FontWeight.w400, height: 1.35, color: const Color(0xFF8B949E)),
            labelLarge: GoogleFonts.poppins(fontSize: 15, fontWeight: FontWeight.w500, color: const Color(0xFFE6EDF3)),
          )
          .apply(bodyColor: const Color(0xFFB0BEC5), displayColor: const Color(0xFFE6EDF3)),
      appBarTheme: AppBarTheme(
        backgroundColor: card,
        foregroundColor: const Color(0xFFE6EDF3),
        elevation: 0,
        surfaceTintColor: Colors.transparent,
        titleTextStyle: GoogleFonts.poppins(fontSize: 18, fontWeight: FontWeight.w500, color: const Color(0xFFE6EDF3)),
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(16), borderSide: const BorderSide(color: Color(0xFF30363D))),
        ...
        contentPadding: const EdgeInsets.symmetric(horizontal: 18, vertical: 16),
        hintStyle: GoogleFonts.poppins(color: const Color(0xFF8B949E), fontSize: 14),
      ),
      bottomSheetTheme: const BottomSheetThemeData(
