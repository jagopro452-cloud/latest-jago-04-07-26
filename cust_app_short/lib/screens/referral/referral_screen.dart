              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Expanded(child: _statCard('Total Referrals', '$_totalReferrals', Icons.people_alt_rounded, Color(0xFF2C95F1), cardBg, textColor, subColor)),
                        const SizedBox(width: 12),
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          _dividerLine(cardBg),
                          _howStep('2', 'Friend Jago download చేసి signup చేయాలి', Icons.person_add_alt_1_rounded, Color(0xFF2C95F1)),
                          _dividerLine(cardBg),
                          ...
                          itemBuilder: (_, i) {
                            ...
                            return ListTile(
                              leading: CircleAvatar(
                                backgroundColor: (type == 'driver' ? Colors.blue : Color(0xFF2C95F1)).withValues(alpha: 0.1),
                                child: Icon(type == 'driver' ? Icons.drive_eta : Icons.person, color: type == 'driver' ? Colors.blue : Color(0xFF2C95F1), size: 20),
                              ),
