...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final accentColor = const Color(0xFF2C95F1); // Premium Purple
                ...
                Container(
                  ...
                  child: Row(children: [
                    ...
                    _statItem('Spent', '₹${_totalSpent.toStringAsFixed(0)}',
                        Icons.payments_rounded, const Color(0xFF2C95F1)),
                  ]),
                ),
                ...
                Container(
                  ...
                  child: Column(children: [
                    ...
                    _premiumTile(Icons.search_rounded, 'Lost & Found', 
                        const Color(0xFF2C95F1), () => Navigator.push(context, MaterialPageRoute(
